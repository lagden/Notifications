...
return null!=d&&(g="number"==typeof d||"="!==d.charAt(1)?Number(d)-c:parseInt(d.charAt(0)+"1",10)*Number(d.substr(2)))?(this._firstPT=h={_next:this._firstPT,t:a,p:b,s:c,c:g,f:"function"==typeof a[b],n:e||b,r:f},h._next&&(h._next._prev=h),h):void 0},f.setRatio=function(a){for(var b,c=this._firstPT,d=1e-6;c;)b=c.c*a+c.s,c.r?b=Math.round(b):d>b&&b>-d&&(b=0),c.f?c.t[c.p](b):c.t[c.p]=b,c=c._next},f._kill=function(a){var b,c=this._overwriteProps,d=this._firstPT;if(null!=a[this._propName])this._overwriteProps=[];else for(b=c.length;--b>-1;)null!=a[c[b]]&&c.splice(b,1);for(;d;)null!=a[d.n]&&(d._next&&(d._next._prev=d._prev),d._prev?(d._prev._next=d._next,d._prev=null):this._firstPT===d&&(this._firstPT=d._next)),d=d._next;return!1},f._roundProps=function(a,b){for(var c=this._firstPT;c;)(a[this._propName]||null!=c.n&&a[c.n.split(this._propName+"_").join("")])&&(c.r=b),c=c._next},F._onPluginEvent=function(a,b){var c,d,e,f,g,h=b._firstPT;if("_onInitAllProps"===a){for(;h;){for(g=h._next,d=e;d&&d.pr>h.pr;)d=d._next;(h._prev=d?d._prev:f)?h._prev._next=h:e=h,(h._next=d)?d._prev=h:f=h,h=g}h=b._firstPT=e}for(;h;)h.pg&&"function"==typeof h.t[a]&&h.t[a]()&&(c=!0),h=h._next;return c},W.activate=function(a){for(var b=a.length;--b>-1;)a[b].API===W.API&&(L[(new a[b])._propName]=a[b]);return!0},q.plugin=function(a){if(!(a&&a.propName&&a.init&&a.API))throw"illegal plugin definition.";var b,c=a.propName,d=a.priority||0,e=a.overwriteProps,f={init:"_onInitTween",set:"setRatio",kill:"_kill",round:"_roundProps",initAll:"_onInitAllProps"},g=r("plugins."+c.charAt(0).toUpperCase()+c.substr(1)+"Plugin",function(){W.call(this,c,d),this._overwriteProps=e||[]},a.global===!0),h=g.prototype=new W(c);h.constructor=g,g.API=a.API;for(b in f)"function"==typeof a[b]&&(h[f[b]]=a[b]);return g.version=a.version,W.activate([g]),g},d=a._gsQueue){for(e=0;e<d.length;e++)d[e]();for(f in o)o[f].func||a.console.log("GSAP encountered missing dependency: com.greensock."+f)}h=!1}}("undefined"!=typeof module&&module.exports&&"undefined"!=typeof global?global:this||window,"TweenMax"),function(a,b){"function"==typeof define&&define.amd?define(["greensock/TweenMax"],b):a.Notifications=b(a.TweenMax)}(this,function(a){"use strict";var b,c,d;return d={getTemplate:function(){return['<h3 class="theNotification__title">{title}</h3>','<p class="theNotification__msg">{msg}</p>'].join("")},extend:function(){var a,b,c,d,e;for(c=c||{},d=0,e=arguments.length;e>d;d++)if(a=arguments[d],a!==!1)for(b in a)a.hasOwnProperty(b)&&(c[b]=a[b]);return c},selfRemove:function(a,b){setTimeout(function(){return a.dispatchEvent(new CustomEvent("click"))},b)}},c={duration:5e3,container:null,offset:10},b=function(){function b(a){return!1==this instanceof b?new b(a):(this.opts=d.extend({},c,a),this.items=[],this.events={},this.container=this.opts.container||document.body,void(this.template=this.opts.template||d.getTemplate()))}return b.prototype.notifica=function(a,b){var c,d,e,f,g,h;g={title:a,msg:b},c=this.template.replace(/\{(.*?)\}/g,function(a,b){return g[b]}),d=document.createElement("div"),d.className="theNotification",d.style.opacity=0,d.insertAdjacentHTML("afterbegin",c),f=[0,this.opts.offset],e=this.items[this.items.length-1],e&&(f[0]=parseInt(e.getAttribute("data-offset"),10),f[1]=parseInt(f[0]+e.offsetHeight+this.opts.offset,10)),h="evt"+String(Math.random()*Date.now()).split(".")[0],this.events[h]=this.remove.bind(this),d.setAttribute("data-offset",f[1]),d.setAttribute("data-event",h),d.addEventListener("click",this.events[h],!1),this.items.push(d),this.render(d,f)},b.prototype.render=function(b,c){var e,f;this.container.appendChild(b),e={y:c[0],opacity:0},f={y:c[1],opacity:1,onComplete:d.selfRemove,onCompleteParams:[b,this.opts.duration]},a.fromTo(b,.5,e,f)},b.prototype.remove=function(b){var c,d,e,f;c=b.currentTarget,e=c.getAttribute("data-event"),c.removeEventListener("click",this.events[e],!1),d=function(a){var b;b=this.items.indexOf(a),-1!==b&&(this.container.removeChild(this.items[b]),this.items.splice(b,1))},f={y:"-=30",opacity:0,onComplete:d.bind(this,c)},a.to(c,.3,f)},b}()});
